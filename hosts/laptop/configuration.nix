...

{
  ...
  # services.xserver.displayManager.sessionCommands = "sleep 5 && ${pkgs.xorg.xmodmap}/bin/xmodmap -e 
  #         'keycode 66 = Escape' &";
  ...
  #       !add Lock = Escape
  #       
  #       ! Remap Right shift to super
  #       clear shift
  #       keycode 62 = Super_L NoSymbol Super_L
  #       
  ...
  #       !add mod4 = Alt_L
  #       
  #       ! Reset left Alt and left Win to Defaults
  #       remove mod1 = Super_L
  #       remove mod4 = Alt_L
  #       add mod1 = Alt_L
  #       add mod4 = Super_L
